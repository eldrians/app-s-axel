...
const AboutItem = ({
  ...
  return (
    <div className="p-8 px-8 flex flex-col justify-center items-center shadow-xl rounded-lg bg-white">
      <div className="mb-4">
...
const About = () => {
  return (
    <section
      id="about"
      className="px-10 md:px-20 lg:px-28 py-4 lg:py-20 bg-slate-100"
    >
      <center>
        <div className="mb-12">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-darkApp uppercase">
            about
          </h2>
        </div>
