...
export const GeneratePDFPilmapres = (
  type: string,
  totalScoreX: number,
  dataKompetisi: any,
  dataKaryaIlmiah: any,
  ...
  autoTable(doc, {
    head: [
      [
        ...
        {
          content: "Total Skor   :" + " " + totalScoreX,
          styles: {
            halign: "left",
            fontStyle: "bold",
            font: "times",
      ...
      [
        {
          ...
          styles: {
            ...
            fontSize: 10,
            textColor: "#000",
            cellPadding: { top: 12, bottom: 10 },
          },
        },
        {
          content: "Ketua Program Studi Ilmu Komputer",
          styles: {
            halign: "right",
            font: "times",
            fontStyle: "normal",
      ...
      [
        {
          ...
          styles: {
            ...
            fontSize: 10,
            textColor: "#000",
            cellPadding: { top: 12, bottom: 0 },
          },
        },
        {
          content: "(Dr. Muhammad Nursalman, M.T)",
          styles: {
            halign: "right",
            font: "times",
            fontStyle: "normal",
  ...
  if (type == "mahasiswa") {
    namaFile = nim + "_" + nama + "_Pilmapres";
  } else {
    namaFile = "Data Prestasi";
  }
